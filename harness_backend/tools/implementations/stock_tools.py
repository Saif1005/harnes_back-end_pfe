...
from harness_backend.services.stock_runtime import get_inventory_state, rebuild_stock_base_from_dataset


def run_stock_check(query: str) -> dict:
    runtime = get_inventory_state()
    if runtime.get("inventory_map"):
        runtime["query"] = query
        return runtime
